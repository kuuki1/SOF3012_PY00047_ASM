...
<head>
    ...
    <style>
        ...
        .video-form-container select:focus {
            border-color: #007bff;
            outline: none;
        }
            ...
            <tbody>
                <c:forEach var="user" items="${userList}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/user/management/edit/${user.id}" class="btn-edit">Edit</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
